      ...
      <header class="nav">
        ...
        <div class="nav-actions">
          ...
          <button className="btn-ghost" onClick={handleUploadClick}>
            <span class="pill">
              <span class="dot"></span> Upload files
            </span>
          </button>
      ...
      >
        ...
        <DialogContent>
          <Typography gutterBottom>
            You are about to start a new accounting session. Please enter your
            company name:
          </Typography>
          <input
            type="text"
        ...
        <Grid size={12}>
          <section className="card">
            <div className="card-inner intro-inner">
              ...
              <p className="lead">
                AI Bookkeeper extracts data from your <strong>invoices</strong>,{" "}
                <strong>journals</strong>,<strong>ERP ledgers</strong>, and{" "}
                <strong>bank statements</strong> — then instantly generates
                reconciliations, trial balances, and discrepancy reports. No
                spreadsheets. No copy-paste.
              </p>
              <p className="lead">
                <b>Try it now:</b> Click the <b>Upload files</b> button to
                upload your invoices and bank statements, and see how AI
                Bookkeeper can transform your accounting workflow.
              </p>
              ...
              <div className="visual">
                <div className="flow">
                  <div className="doc">
                    ...
                    <div className="row">
                      <span className="muted">Acme Ltd.</span>
                      <span>$ 12,400.00</span>
                    </div>
                    <div className="row">
                      <span className="muted">Consulting</span>
                      <span>$ 3,200.00</span>
                    </div>
                    <div className="row">
                  ...
                  <div className="out">
                    ...
                    <div className="out-row">
                      <span>Matched txns</span>
                      <b className="ok">96.4%</b>
                    </div>
                    <div className="out-row">
                      <span>Trial balance</span>
                      <b className="ok">Balanced</b>
                    </div>
              ...
              <div className="features">
                ...
                <div className="feat">
                  ...
                  <p>
                    Pulls structured data from PDFs, scans, and ERP exports.
                  </p>
                </div>
                ...
                <div className="feat">
                  ...
                  <p>
                    Matches invoices to bank lines and flags every variance.
                  </p>
                </div>
              </div>
            </div>
                ...
                Upload Invoices File:
                  ...
                  >
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setInvoicesData(Array.from(e.target.files))
                      }
                      style={{ display: "none" }}
                      multiple
                    />
